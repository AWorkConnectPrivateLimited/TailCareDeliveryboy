  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        value != null ? Text(
          value!, style: robotoBold.copyWith(fontSize: 40, color: const Color(0xFF3d4152)), textAlign: TextAlign.center,
        ...
        Text(
          title,
          style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: const Color(0xFF3d4152)),
