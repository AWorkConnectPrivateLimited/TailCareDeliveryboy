            ...
            return Column(children: [
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      const SizedBox(width: Dimensions.paddingSizeSmall),
                      Image.asset(Images.wallet, width: 60, height: 60,color: const Color(0xFF3d4152),),
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text(
                          'balance'.tr,
                          style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: const Color(0xFF3d4152)),
                        ),
                        ...
                        profileController.profileModel != null ? Text(
                          ...
                          style: robotoBold.copyWith(fontSize: 24, color: const Color(0xFF3d4152)),
                    ...
                    Row(children: [
                      ...
                      Container(height: 30, width: 1, color: const Color(0xFF3d4152)),
              ...
              Row(children: [
                ...
                Expanded(child: CountCardWidget(
                  title: 'todays_orders'.tr, backgroundColor: const Color(0xFFd6ffd2), height: 180,
                  value: profileController.profileModel?.todaysOrderCount.toString(),
                )),
                const SizedBox(width: Dimensions.paddingSizeSmall),

                Expanded(child: CountCardWidget(
                  title: 'this_week_orders'.tr, backgroundColor: const Color(0xFFf0d2d2), height: 180,
              ...
              CountCardWidget(
                title: 'total_orders'.tr, backgroundColor: const Color(0xFFffedd7), height: 140,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(mainAxisAlignment: profileController.profileModel!.cashInHands! > 0 && profileController.profileModel!.earnings == 1 ? MainAxisAlignment.spaceBetween : MainAxisAlignment.center, children: [
                      ...
                      Text(PriceConverterHelper.convertPrice(profileController.profileModel!.cashInHands), style: robotoBold.copyWith(fontSize: 30,color: const Color(0xFF3d4152))),
                      const SizedBox(width: Dimensions.paddingSizeSmall),
                    ...
                    Text('cash_in_your_hand'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge,color: const Color(0xFF3d4152))),
